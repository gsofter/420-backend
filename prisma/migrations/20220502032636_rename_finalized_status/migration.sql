/*
  ...
  - The values [FINALIZED] on the enum `BreedPairStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "BreedPairStatus_new" AS ENUM ('PAIRED', 'COMPLETED', 'MAX_REACHED', 'FAILED');
